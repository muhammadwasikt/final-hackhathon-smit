...
export const sendEmailVerification = async (email, otp , token) => {
    try {
        transporter.sendMail({
            ...
            <p style ='margin: 10px auto'>Click the link below to verify your email.<a href=https://final-hackhathon-smit.vercel.app/email-verification/${token}>verify email</a></p>
            `,
        })
        console.log('Reset email sent to:', email);
    }
